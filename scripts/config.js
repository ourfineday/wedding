...
window.WEDDING_CONFIG = {
  // ── 기본 정보 ──
  groom: { name: "김민준", parents: "김영수 · 박은정" }, // 신랑 (parents = 부모님 성함, 비우면 혼주 표기 생략)
  bride: { name: "이서연", parents: "이정호 · 최미경" }, // 신부
  wedding: {
  ...
  // ── 표시 설정 ──
  theme: "minimal", // 확정 테마: minimal | fresh | classic | natural | reference
  previewMode: true, // 테마 비교용(상단 바). 확정하면 false로 → config.theme만 적용됩니다.
};
